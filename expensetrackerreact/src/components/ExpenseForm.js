...
export const ExpenseForm = () => {
  return (
    <>
      <form className="flex flex-col md:flex-row md:flex-wrap md:justify-between md:items-center md:p-4 md:bg-blue-700 md:min-w-max gap-2 mt-2 justify-center items-center">
